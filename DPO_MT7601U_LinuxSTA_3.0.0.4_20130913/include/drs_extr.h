...
/* FUNCTION */
VOID MlmeGetSupportedMcs(IN struct _RTMP_ADAPTER *pAd,
			 IN UCHAR * pTable, OUT CHAR mcs[]);
...
VOID MlmeSetTxQuality(IN struct _MAC_TABLE_ENTRY *pEntry,
		      IN UCHAR rateIndex, IN USHORT txQuality);
...
VOID MlmeOldRateAdapt(IN struct _RTMP_ADAPTER *pAd,
		      ...
		      IN ULONG TrainUp,
		      IN ULONG TrainDown, IN ULONG TxErrorRatio);

VOID MlmeRestoreLastRate(IN struct _MAC_TABLE_ENTRY *pEntry);

VOID MlmeCheckRDG(IN struct _RTMP_ADAPTER *pAd,
		  IN struct _MAC_TABLE_ENTRY *pEntry);
...
VOID StaQuickResponeForRateUpExecAdapt(IN struct _RTMP_ADAPTER *pAd,
				       IN ULONG i, IN CHAR Rssi);
...
VOID MlmeRALog(IN struct _RTMP_ADAPTER *pAd,
	       ...
	       IN ULONG TxErrorRatio, IN ULONG TxTotalCnt);

VOID MlmeSelectTxRateTable(IN struct _RTMP_ADAPTER *pAd,
			   IN struct _MAC_TABLE_ENTRY *pEntry,
			   IN UCHAR ** ppTable,
			   IN UCHAR * pTableSize, IN UCHAR * pInitTxRateIdx);
