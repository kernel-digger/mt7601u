...
/*
	...
	========================================================================
*/
VOID RTMPConstructCCMPAAD(IN PUCHAR pHdr,
			  IN BOOLEAN isDataFrame,
			  IN UINT8 a4_exists,
			  IN UINT8 qc_exists,
			  OUT UCHAR * aad_hdr, OUT UINT * aad_len)
{
	UINT len = 0;
...
/*
	...
	========================================================================
*/
VOID RTMPConstructCCMPNonce(IN PUCHAR pHdr,
			    IN UINT8 a4_exists,
			    IN UINT8 qc_exists,
			    IN BOOLEAN isMgmtFrame,
			    IN UCHAR * pn,
			    OUT UCHAR * nonce_hdr, OUT UINT * nonce_hdr_len)
{
	UINT n_offset = 0;
	INT i;
			    ...
			    INOUT PUCHAR pData, IN UINT32 DataLen)
{
	...
	RTMPConstructCCMPAAD(pHdr,
			     ...
			     a4_exists, qc_exists, aad_hdr, &aad_len);
...
VOID CCMP_test_vector(IN PRTMP_ADAPTER pAd, IN INT input)
{
	...
	UINT8 P_TEXT_DATA[20] =
	    { 0xf8, 0xba, 0x1a, 0x55, 0xd0, 0x2f, 0x85, 0xae,
		0x96, 0x7b, 0xb6, 0x2f, 0xb6, 0xcd, 0xa8, 0xeb,
		0x7e, 0x78, 0xa0, 0x50
	};
	UINT8 C_TEXT_DATA[28] =
